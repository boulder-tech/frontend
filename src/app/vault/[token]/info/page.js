            ...
            <div class="h-full-flex max-w-full 2xl:mx-auto 2xl:max-w-7xl overflow-hidden">
                <div data-v-69ed45e4="">
                    ...
                    <section data-v-69ed45e4="" class="h-full-flex">
                        ...
                        <div data-v-69ed45e4="">
                            <div
                                class="flex w-full grow flex-col gap-6 2xl:flex-row"
                                isowner="false"
                            >
                                <div class="space-y-6 h-full-flex">
                                    <div class="">
                                        <div class="bg-white rounded-lg border border-gray-400 p-4 md:p-6">
                                            <section class="mb-8">
                                                <h3 class="text-xl font-semibold">
                                                    Strategy description
                                                </h3>
                                                <p class="mt-4 text-sm leading-5">
                                                    Boulder Tech AMM trading
                                                    strategy is based on the
                                                    Constant Product Market
                                                    Maker model (known for its
                                                    formula x * y = k), which
                                                    involves providing liquidity
                                                    to a particular trading pair
                                                    by holding an equal value of
                                                    the two assets in the pair.
                                                    This strategy is what the
                                                    popular Uniswap v2 is based
                                                    on.
                                                </p>
                                            </section>
                                            <h4 class="text-gray-500 uppercase font-semibold text-xs tracking-widest">
                                                Details
                                            </h4>
                                            <div class="border-gray-750 border-b border-opacity-10 my-4 -mx-6"></div>
                                            <div class="flex flex-col xs:flex-row xs:items-start justify-between xs:space-x-4 font-semibold max-xs:space-y-2">
                                                <h4 class="text-base whitespace-nowrap flex items-center gap-1">
                                            ...
                                            <div class="flex flex-col xs:flex-row xs:items-start justify-between xs:space-x-4 font-semibold max-xs:space-y-2">
                                                ...
                                                <div class="text-sm break-all">
                                                    <a
                                                        href="https://testnet.explorer.injective.network/markets/?tab=marketsInfo&amp;marketId=0x5777730c1ab6f6b1e465d41778562ada8c136c0f11ffbbdb2faa7a5bbde5d5a5&amp;marketType=Spot"
                                                        rel="noopener noreferrer"
                                                        target="_blank"
                                                        class="text-green-600 hover:opacity-70"
                                                    >
                                                        {token}
                                                    </a>
                                                </div>
                                    ...
                                    <div class="">
                                        <div class="py-4 px-6 bg-white rounded-lg border border-gray-400">
                                            <h4 class="text-gray-500 uppercase font-semibold text-xs tracking-widest">
                                                Vault Info
                                            </h4>
                                            <div class="border-gray-750 border-b border-opacity-10 my-4 -mx-6"></div>
                                            <div class="grid gap-x-8 lg:grid-cols-2 2xl:gap-x-16">
                                                <div class="flex flex-col xs:flex-row xs:items-start justify-between xs:space-x-4 font-semibold max-xs:space-y-2 col-span-2 my-4">
                                                    <h4 class="text-base whitespace-nowrap flex items-center gap-1">
                                                        <div class="first-letter:uppercase">
                                                            Vault Address
                                                        </div>
                                                    ...
                                                    <div class="text-sm break-all">
                                                        <a
                                                            href="https://testnet.explorer.injective.network/contract/inj1xvlnfmq5672rmvn6576rvj389ezu9nxc9dpk8l/"
                                                            rel="noopener noreferrer"
                                                            target="_blank"
                                                            class="text-green-600 hover:opacity-70"
                                                        >
                                                            inj1xvlnfmq5672rmvn6576rvj389ezu9nxc9dpk8l
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="flex flex-col xs:flex-row xs:items-start justify-between xs:space-x-4 font-semibold max-xs:space-y-2 col-span-2 my-4">
                                                    ...
                                                    <div class="text-sm break-all">
                                                        <a
                                                            href="https://testnet.explorer.injective.network/contract/inj1an0gxz8w2sfavu5glt32hly5m2ltz67eyx2gra/"
                                                            rel="noopener noreferrer"
                                                            target="_blank"
                                                            class="text-green-600 hover:opacity-70"
                                                        >
                                                            inj1an0gxz8w2sfavu5glt32hly5m2ltz67eyx2gra
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="flex flex-col xs:flex-row xs:items-start justify-between xs:space-x-4 font-semibold max-xs:space-y-2 col-span-2 my-4">
                                                    ...
                                                    <div class="text-sm break-all">
                                                        <a
                                                            href="https://testnet.explorer.injective.network/account/inj1995xnrrtnmtdgjmx0g937vf28dwefhkhy6gy5e/"
                                                            rel="noopener noreferrer"
                                                            target="_blank"
                                                            class="text-green-600 hover:opacity-70"
                                                        >
                                    ...
                                    <div class="cursor-pointer">
                                        <div class="inline-flex items-center gap-1 border rounded-lg text-green-600 border-green-600 px-3 py-2 hover:opacity-70">
                                            <span class="text-sm font-semibold">
                                                View vault strategy parameters
                                            </span>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 24 24"
                                                class="cursor-pointer h-4 w-4 min-w-4 transform rotate-180 mt-px"
                                            >
                                                <path
                                                    d="M21 11L6.414 11 11.707 5.707 10.293 4.293 2.586 12 10.293 19.707 11.707 18.293 6.414 13 21 13z"
                                                    fill="currentColor"
